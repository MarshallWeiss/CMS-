import svgPaths from "./svg-msvt5tcn9n";
...
function ChevronDown() {
  return (
    <div
      className="absolute left-[11.322px] size-[14.502px] top-3.5"
    ...
    >
      ...
      >
        <g id="chevron-down">
          <path
            d={svgPaths.p1c7bb700}
            id="Vector"
            stroke="var(--stroke-0, #020617)"
            strokeLinecap="round"
            strokeLinejoin="round"
            strokeWidth="0.755285"
          />
        </g>
      </svg>
    </div>
...
function ChevronDown1() {
  return (
    <div className="relative size-[14.502px]" data-name="chevron-down">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
...
function Group1318() {
  return (
    <div className="absolute contents left-[11.317px] top-[-0.501px]">
      <ChevronDown />
      <div className="absolute flex items-center justify-center left-[11.314px] size-[14.502px] top-[-0.501px]">
