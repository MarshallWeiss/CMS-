  ...
  return (
    <div className="box-border content-stretch flex flex-col items-start justify-center p-0 relative shrink-0">
      <div className="font-['Inter:Regular',_sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.87)] text-left text-nowrap">
        <p className="block leading-[20px] whitespace-pre">Vertical</p>
      </div>
    </div>
  );
}
...
function Frame1543() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[0.638px] items-start justify-start p-0 relative shrink-0 w-full">
      <div className="bg-[rgba(204,204,204,0.4)] h-[1.915px] rounded-[1.078px] shrink-0 w-[30.956px]" />
      <div className="bg-[rgba(204,204,204,0.4)] h-[1.915px] rounded-[1.078px] shrink-0 w-[24.254px]" />
    </div>
  );
}
...
function Frame1544() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[0.638px] items-start justify-start p-0 relative shrink-0 w-full">
      <div className="bg-[rgba(204,204,204,0.4)] h-[0.957px] rounded-[1.078px] shrink-0 w-[21.382px]" />
      <div className="bg-[rgba(204,204,204,0.4)] h-[0.957px] rounded-[1.078px] shrink-0 w-[22.978px]" />
      <div className="bg-[rgba(204,204,204,0.4)] h-[0.957px] rounded-[1.078px] shrink-0 w-[18.829px]" />
    </div>
  );
}
...
function Header() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-[0.947px] items-start justify-center pb-[6.16px] pt-[3.08px] px-0 relative shrink-0"
      data-name="Header"
    >
      <div className="bg-[rgba(204,204,204,0.4)] h-[1.277px] rounded-[1.078px] shrink-0 w-[10.531px]" />
      <Frame1543 />
      <Frame1544 />
    </div>
  );
...
function Picture() {
  return (
    <div
      className="bg-[rgba(204,204,204,0.4)] h-8 order-1 overflow-clip relative rounded-[2.55px] shrink-0 w-6"
      data-name="Picture"
    >
      <div
        ...
        style={{ top: "calc(50% - 7px)", left: "calc(50% - 8.036px)" }}
      >
        <p className="block leading-[14px] whitespace-pre">3:4</p>
      </div>
    </div>
  );
}
...
function Figure() {
  return (
    <div
      className="box-border content-stretch flex flex-col-reverse gap-[0.44px] items-start justify-start p-0 relative shrink-0"
      data-name="Figure"
    >
      <Picture />
    </div>
...
function Frame1772() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-[3.08px] items-center justify-start p-0 top-1/2 translate-x-[-50%] translate-y-[-50%]"
      style={{ left: "calc(50% + 0.018px)" }}
    >
      <Header />
      <Figure />
    </div>
...
function Frame1774() {
  return (
    <div className="h-7 relative shrink-0 w-[58px]">
      <Frame1772 />
    </div>
  );
}
