...
export function AudioModal({ isOpen, onClose, onInsert, initialData }: AudioModalProps) {
        ...
        <div className="flex flex-col gap-4 h-full">
          ...
          <div className="flex flex-row gap-6 items-start justify-start w-full">
            <div className="flex-1">
              <h2 className="text-base font-semibold text-zinc-900 leading-[22px] text-[16px] text-[15px]">Insertar Audio</h2>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-2 flex-1">
              ...
              <div className="flex-1 bg-white border border-[#cccccc] rounded flex flex-col">
                <textarea
                  ...
                  placeholder="URL de Spotify, SoundCloud o archivo de audio"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-white border border-[#cccccc] rounded">
                <input
                  ...
                  placeholder="Insertar el pie del audio"
